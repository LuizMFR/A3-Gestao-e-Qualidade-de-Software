...
PERFION 
Gestoe de finanças pessoais fácil e intuitivo para o controle de suas finanças pessoais 
...
Instruções para rodar parte do cliente: 
  ...
  Abra um terminal na pasta Cliente 
  Execute o comando "mvn clean javafx:run"
